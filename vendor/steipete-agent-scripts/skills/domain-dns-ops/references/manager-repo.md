# `~/Projects/shared/manager` pointers
...
- `bin/namecheap-set-ns`: Namecheap NS flip helper (env vars in `~/Projects/shared/manager/profile`).
- `bin/cloudflare-ai-bots`: bot management helper (needs token perms).

## Fast navigation

- Find a domain: `rg -n \"\\bexample\\.com\\b\" ~/Projects/shared/manager/DOMAINS.md`
- List scripts: `ls -la ~/Projects/shared/manager/bin`
