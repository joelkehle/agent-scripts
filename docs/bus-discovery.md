...
This is separate from Codex / Claude Code build-agent coordination. For cross-host coding claims, handoffs, patches, and proof packs on Dev, Beelink, and Mac Mini, read `~/Projects/shared/agent-scripts/docs/shared-agent-coordination.md`.
