...
assert_contains "$sweep_dry" "janitor dry-run stale=2 eligible=1 skipped_recent=1 released=0 invalid=0 invalid_eligible=0 released_invalid=0 errors=0 stale_after_days=7"
