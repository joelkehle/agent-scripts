...
- Infra notes: `~/Projects/agent-infra` (read before ops).
- Surface access from beelink: use `ssh -p 2222 joelkehle@laptop` (WSL portproxy path). Do not rely on `JoelSurface5` mDNS hostname from beelink.
